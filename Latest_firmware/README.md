...
![Alt Text](https://github.com/tronicgr/AMC-AASD15A-Firmware/blob/master/Latest_firmware/AVRBD_Flash_Size_setting_128k.jpg)
...
### Alternative settings in AVRDB for loading the fimware to new 256k Atmega boards:
